  ...
  head: () => ({
    meta: [
      { title: "Admissions — Boriyad Youth Academy" },
      {
        name: "description",
        content:
          "Apply to Boriyad Youth Academy. Fair, inclusive, transparent admissions for KG through Grade 12 — 2026/2027 intake now open.",
      },
      { property: "og:title", content: "Admissions — Boriyad Youth Academy" },
      {
        property: "og:description",
        content:
          "Fair, inclusive, transparent admissions for KG–Grade 12. Apply or arrange a campus tour.",
      },
    ],
  }),
...
function AdmissionsPage() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (insErr) {
      setError(
        "Sorry, your application could not be submitted. Please try again or contact us directly.",
      );
      return;
    }
    setRefId(ref);
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:gap-14 lg:px-8">
          ...
          <div className="space-y-4 text-base leading-relaxed text-navy-900/75 lg:col-span-7">
            <p>
              At Boriyad Youth Academy, our admissions process is grounded in our core values of
              equity, respect, and diversity. Admission is open to all applicants — regardless of
              academic background, nationality, ethnicity, religion, or gender.
            </p>
            <p>
              We warmly invite families to visit the school before registration, giving prospective
              students and parents the opportunity to tour our facilities, meet our staff, and
              experience the learning environment that defines life at Boriyad. We are committed to
              working closely with every family to support the continued growth of each child.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-cream py-20 md:py-28">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">
              Transparent annual tuition by stage. Sibling and early-payment discounts available.
              Final fees confirmed in the offer letter.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <FeeNote
              ...
              body="ETB 1,500 due at submission. Refundable if a place is not offered."
            />
            <FeeNote
              title="Registration Deposit"
              body="ETB 5,000 to secure your child's place once an offer is accepted."
            />
            <FeeNote
              title="Sibling Discount"
              body="5% second child · 10% third child · 15% fourth child on tuition."
            />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-10 px-4 sm:px-6 lg:grid-cols-12 lg:gap-14 lg:px-8">
          <div className="lg:col-span-7">
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-white/75">
              Seeing is believing. We warmly invite prospective parents and students to visit our
              campus and experience the welcoming atmosphere that defines life at Boriyad. Whether
              you're ready to enroll or simply exploring, we'd be delighted to show you around.
            </p>
            <Link
              to="/contact"
          ...
          <div className="space-y-4 lg:col-span-5">
            <TourLine
              ...
              body="Monday – Friday · 9:00 AM – 3:00 PM. Weekend visits on request."
            />
            ...
            <TourLine
              icon={CalendarIcon}
              title="Next Intake"
              body="2026/2027 academic year — applications open."
            />
          </div>
        </div>
      </section>
          ...
          {submitted ? (
            <div className="mt-12 rounded-sm border border-gold-500/40 bg-white p-10 text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                Thank you. Our admissions team will contact you within 2 business days to schedule
                next steps.
              </p>
            ...
            <form
              onSubmit={onSubmit}
              className="mt-12 grid gap-8 rounded-sm border border-navy-900/10 bg-white p-8"
            >
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="grid gap-5">
      <p className="border-b border-navy-900/10 pb-2 text-xs font-semibold uppercase tracking-[0.2em] text-gold-600">
        {title}
      </p>
      {children}
    </div>
